...
const Stat = ({ value, label }: { value: string; label: string }) => (
  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl px-5 py-4">
    <div className="text-3xl font-extrabold text-[#b0db9c] tracking-tight">
      {value}
    </div>
...
const CTAButton = ({
  ...
  const common =
    "inline-flex items-center justify-center rounded-full px-6 py-3 text-lg font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#b0db9c] focus-visible:ring-offset-black";
  const styles =
    variant === "primary"
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center pt-32 pb-20">
            <div className="lg:col-span-7 relative z-10">
              ...
              <p className="mt-6 text-xl text-gray-300 max-w-2xl">
                Compassion in action—education, health, environment, human
                rights, and dignity in food and clothing—so no one feels
                forgotten. Join the movement to uplift lives with purpose.
              </p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            Achena Sukh means unknown happiness—deeper fulfillment born from
          ...
          <blockquote className="mt-8 bg-[#111]/70 border border-white/10 rounded-2xl p-6 text-left">
            <p className="text-xl text-gray-200 leading-relaxed">
              “We bring light where there was pause, uplift lives, and make
              dreams possible—because kindness and solidarity are the
              foundations of every resilient community.”
            </p>
          </blockquote>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-[#1f1f1f] border border-white/10 p-8 rounded-2xl">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Reach those struggling in silence with not just aid, but hope,
              empowerment, and belonging—through compassionate outreach and
              sustainable support.
            </p>
            <p className="text-gray-300 leading-relaxed">
              With a deeply committed team, we uplift lives, restore faith in
              humanity, and help build futures grounded in kindness and
              solidarity.
            </p>
          </div>
          ...
          <div className="bg-[#1f1f1f] border border-white/10 p-8 rounded-2xl">
            ...
            <p className="text-gray-300 leading-relaxed">
              A world where no one feels forgotten, helpless, or alone—where
              every person has access to dignity, care, and opportunity,
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          <FieldCard icon={BookOpen} title="Education">
            Education is the foundation of a developed society. We enable access
          ...
          <FieldCard icon={Scale} title="Human Rights">
            We promote and protect rights for marginalized groups, standing
            against discrimination, exploitation, and violence in pursuit of
            equality and justice.
          </FieldCard>
          <FieldCard icon={Shirt} title="Food & Clothing">
            We deliver essential food support and clothing—especially in extreme
            weather—so every person can meet basic needs with dignity.
          </FieldCard>
          <FieldCard icon={HeartHandshake} title="Community Empowerment">
            We co-create local solutions with community partners and volunteers,
            prioritizing participation, accountability, and long-term
            resilience.
          </FieldCard>
        </div>
      </section>
      ...
      >
        <div className="text-center bg-[#101010] border border-white/10 p-12 rounded-2xl">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Together, it’s possible to make a measurable difference—one act of
            unknown happiness at a time.
          </p>
